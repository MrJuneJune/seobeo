...
"int Insert{{TABLE_NAME}}(PGconn *conn, {{TABLE_NAME}} u);\n"
"int Update{{TABLE_NAME}}(PGconn *conn, {{TABLE_NAME}} u, const char *where_clause);\n"
"int Delete{{TABLE_NAME}}(PGconn *conn, const char *where_clause);\n"
